...
from charades_i3d_rgb_data_upsample import Charades as Dataset

def run(init_lr=1e-3, max_steps=10e3, mode='rgb', root='i3d_rgb_charades', train_split='charades/charades.json', batch_size=1, save_model='models/baseline/',model='wsgn'):
    # setup dataset
